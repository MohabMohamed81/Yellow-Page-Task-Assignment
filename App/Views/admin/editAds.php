...
if (isset($_POST['submit']) && isset($_POST['description'])) {
    ...
    $adsControllerObject->setAdId($_POST['id']);
    $adsControllerObject->setImage($image);
    $adsControllerObject->setDescription($_POST['description']);
    $result = $adsControllerObject->updateAds();
...
<html>
    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main ">
            ...
            <h1 class="display-1">Edit Advertise</h1>  
            <form action="editAds.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="description" type="text" class="form-control" id="exampleInputDescription" placeholder="Description" value=<?php echo $_GET['description']; ?>>
                </div>
