        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    $result = $commentControllerObject->listUpApprovedComment();
                    if ($result == null) {
                        ?>
                        <div class="alert alert-danger" role="alert">There is no Comments </div>
                        <?php
                    }
                    ?>
                                ...
                                if ($result != null) {
                                    foreach ($result as $val) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href=<?php echo "approveComment.php?id=" . $val['id']; ?>>Approve  </a></td>
                                            <?php if ($_SESSION['type'] == 0) { ?>
                                                <td><a href=<?php echo "deleteComment.php?id=" . $val['id']; ?>>Delete</a></td>
                                            <?php }
                                            ?>
                                        </tr>
                                        <?php
